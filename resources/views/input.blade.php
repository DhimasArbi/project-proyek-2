    ...
    <div class="limiter">
        <div class="container-login100" style="background-image:  url('../Assets/img/bg-01.jpg');">
            <div class="wrap-login100">
                <form class="login100-form validate-form" method="post" enctype="multipart/form-data" action="{{route('batik.store')}}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md">
                            ...
                            <div style="visibility:hidden;">
                                <input type="input" class="form__field" placeholder="status" name="status" id='status' required value="new" />
                            </div>
                        </div>
                    </div>
                    <div class="form__group field">
